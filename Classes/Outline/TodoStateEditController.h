...
@interface TodoStateEditController : UITableViewController {
    Node *node;
    NSArray *todoStateGroups;
    LocalEditAction *editAction;
}

@property (nonatomic, retain) Node *node;
@property (nonatomic, retain) NSArray *todoStateGroups;
